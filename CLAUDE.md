# KIBAH — App de Asesores Inmobiliarios

## Qué es
Plataforma interna para asesores inmobiliarios de Kibah. Consulta de propiedades con filtros avanzados (lista/tarjetas), CRUD admin, control de visibilidad de columnas, webhooks y API keys. Dark/light mode con toggle.
...
- Lectura de propiedades: usar `propiedades_view` (snake_case). Escritura: directo a `base_kibah` (columnas originales con comillas).
