      ...
      <div className="flex items-center gap-2 flex-wrap">
        <button
          ...
          className={`h-7 px-2.5 text-[11px] font-medium rounded-full border transition-colors cursor-pointer flex items-center gap-1.5
            ${!hiddenCategories.has('__none__') ? 'border-[#E8872A]/30 bg-[#E8872A]/10 text-[#E8872A]' : 'border-border-primary text-text-tertiary'}`}
        >
          <div className="w-2 h-2 rounded-full" style={{ backgroundColor: '#E8872A' }} />
          Sin categoria
        </button>
